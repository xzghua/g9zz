...
@section('content')
        ...
        <div class="block-area" id="required">
            ...
            <form role="form" class="form-validation-1" action="/admin/role" method="post">
                {{ csrf_field() }}
                ...
                <div class="row">
                    <div class="col-md-6">
                        <input type="text" name="name" class="form-control m-b-8 input-sm validate[required]" placeholder="请输入角色名">
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <input type="text" name="displayName" class="form-control m-b-8 input-sm validate[required]" placeholder="请输入角色名称">
                    </div>
                </div>
