...
@section('content')
    ...
    <div class="block-area" id="required">
        <form role="form" class="form-validation-1" action="/admin/category/{{$category->id}}" method="post">
            {!! csrf_field() !!}
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <input type="text" value="{{$category->name}}" name="name" class="form-control m-b-8 input-sm validate[required]" placeholder="请输入分类名">
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <input type="text" value="{{$category->description}}" name="description" class="form-control m-b-8 input-sm " placeholder="请输入描述">
                </div>
            </div>
