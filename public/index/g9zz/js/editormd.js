;(function(factory) {
    ...
    editormd.toolbarModes = {
        full : [
            ...
            "h1", "h2", "h3", "h4", "h5", "h6", "|", 
            "list-ul", "list-ol", "hr", "|",
            "link", "reference-link", "image", "code", "preformatted-text", "datetime", "|",
    ...
    editormd.defaults     = {
        ...
        watch                : true,
        placeholder          : "在这里输入你的帖子信息~  使用markdown格式~~",
        gotoLine             : true,
        codeFold             : false,
        autoHeight           : false,
		autoFocus            : true,
    ...
    editormd.loadCSS   = function(fileName, callback, into) {
        ...
        css.href   = "../index/g9zz/" + fileName + ".css";
    ...
    editormd.loadScript = function(fileName, callback, into) {
        ...
        script.src    = "../index/g9zz/" + fileName + ".js";
